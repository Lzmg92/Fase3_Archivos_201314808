...
<!-- //Head -->
	...
	<body>
		...
		<div class="agileitscontainerwthree">
			...
			<form name="formulario"method="get"action="Gestores/Res10.php">
				<fieldset>
					...
					<div class="section agileinfo row">
						<fieldset>
							<div class="form-group wthree col-md-4">
								...
								<input class="form-control" type="text" name="elim" id="elim" value="" placeholder="Nombre archivo" >
							</div>
							<div class="form-group w3-agile col-md-4">
								<label class="control-label" for="initial-1">ID User </label>
								<input class="form-control" type="text" name="idH" id="idH" value="" placeholder="id user">
							</div>
						</fieldset>
					</div>
				
					<button type="submit" value="Submit" class="btn btn-lg agile btn-primary submit">Mostrar</button>
				</div>
			</form>
		</div>
