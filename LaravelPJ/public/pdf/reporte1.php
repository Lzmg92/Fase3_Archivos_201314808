...
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Usuarios nacidos arriba de X año - <?=  $date; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <thead>
                     <tr>
                      ...
                      <th style="width: 10px"><span class="badge bg-red"> AÑO NACIMIENTO </span></th>
                    </tr>
                  </thead>
                    <tbody>
                    <p> 
            <?php
              ...
              $stid = oci_parse($conn, 'SELECT id_usuario ID, usr_nombre NOMBRE, TO_CHAR(usr_nacimiento, \'yyyy\') AÑO FROM USUARIO
                WHERE TO_CHAR(usr_nacimiento, \'yyyy\')>:esto
                ');
