...
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Bitacora de Cambios Realizados - <?=  $date; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <thead>
                     <tr>
                      ...
                      <th style="width: 5px"><span class="badge bg-red"> DESCRIPCION  </span></th>
                      <th style="width: 10px"><span class="badge bg-red"> FECHA MODIFICACION </span></th>
                      <th style="width: 10px"><span class="badge bg-red"> TIPO  </span></th>
                    </tr>
                  </thead>
                    <tbody>
                    <p> 
            <?php
             ...
             $stid = oci_parse($conn, 'SELECT id_usuario, usr_nombre, descripcion, fecha, tipo FROM BITACORA
              ');
             oci_execute($stid);
              echo "<table>\n";
