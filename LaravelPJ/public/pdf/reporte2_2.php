...
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Listado carpetas de un Usuario. </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <thead>
                     <tr>
                      ...
                      <th style="width: 10px"><span class="badge bg-red"> CARPETAS </span></th>
                    </tr>
                  </thead>
                    <tbody>
                    <p> 
            <?php
              ...
              $stid = oci_parse($conn, 'SELECT u.id_usuario, u.usr_nombre, c.nombre
                                        from USUARIO u, CARPETA c
                                        where u.id_usuario = :esto and c.USUARIO_id_usuario = :esto
