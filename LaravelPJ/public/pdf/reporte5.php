...
$variable1=($_GET['fecha']);
?>

<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Listado de clientes registrados en una Y fecha, No. CARPETAS - <?=  $date; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <thead>
                     <tr>
                      ...
                      <th style="width: 10px"><span class="badge bg-red"> NO. CARPETAS </span></th>
                    </tr>
                  </thead>
                    <tbody>
                    <p> 
            <?php
              ...
              $stid = oci_parse($conn, 'SELECT U.usr_nombre Usuario,  TO_CHAR(U.usr_registro, \'yyyy\') Registro, count(*) Carpetas
                from  USUARIO U, carpeta c
                 where U.id_usuario = c.USUARIO_id_usuario and TO_CHAR(U.usr_registro, \'yyyy\')=:esto 
            ...
            ?>
               ...
               <a href="reporte5_2.php?var1=<?php echo $variable1 ?>" target="_blank" ><button class="btn btn-block btn-success btn-xs">Siguiente</button></a>
