...
$variable1=($_GET['fecha1']);
$variable2=($_GET['fecha2']);
echo $variable1;
echo "  ";
echo $variable2;
?>
<div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Clientes que han realizado una modificación en X carpeta en un rango de fechas de Y hasta Z <?=  $date; ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  ...
                  <thead>
                     <tr>
                      ...
                      <th style="width: 10px"><span class="badge bg-red"> NOMBRE CARPETA </span></th>
                    </tr>
                  </thead>
                    <tbody>
                    <p> 
                    <?php
                        ...
                        $stid = oci_parse($conn, 'SELECT id_usuario ID, usr_nombre NOMBRE, nombre_car_arch NOM_CAR
                                                  FROM BITACORA 
                                                  WHERE  tipo =\'carpeta\' and fecha BETWEEN \'09-MAY-17\' and \'14-MAY-17\'
                                                  GROUP BY id_usuario, usr_nombre, nombre_car_arch
                                                  ');
                         oci_execute($stid);
                         echo "<table>\n";
