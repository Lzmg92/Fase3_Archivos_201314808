...
<?php 
	...
	<body>
		...
		<div class="agileitscontainerwthree">
			...
			<form name="formulario"method="get"action="Gestores/Res11.php">
				<fieldset>
					...
					<div class="section agileinfo row">
						<fieldset>
							<div class="form-group wthree col-md-4">
								...
								<input class="form-control"  type="text" name="nombArc" id="nombArc" value="" placeholder="Nombre archivo">
							</div>
							<div class="form-group w3-agile col-md-4">
								<label class="control-label" for="initial-1">ID User </label>
								<input class="form-control" type="text" name="jjjj" id="jjjj" value="" placeholder="id">
							</div>
						</fieldset>
					</div>
					...
					<button type="submit" value="Submit" class="btn btn-lg agile btn-primary submit">Eliminar</button>
				</div>
			</form>
		</div>
